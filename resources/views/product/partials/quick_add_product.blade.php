  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('sku', __('product.sku') . ':') !!} @show_tooltip(__('tooltip.sku'))
              ...
              <input type="hidden" name="prefix" value="{{ $sku_prefixx.'-' }}" class="input-group-addon sku_prefix">
            <div class="input-group">
              <span class="input-group-addon sku_prefix_addon text-uppercase">
                {{ $sku_prefixx.'-' }}
              </span>
              {!! Form::text('sku', null, ['class' => 'form-control sku_no__edit',
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <select class="form-control select2" id="prod_type" name="product_type" required>
                <option value="" selected disabled>Please Select</option>
               @foreach ($types as $t)
                <option value="{{$t->id}}" data-pf="{{$t->prefix}}">{{$t->name}}</option>
              @endforeach
            </select>
          </div>
        </div>
        ...
        <div class="col-sm-4 @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
          <div class="form-group">
            {!! Form::label('child_cat', __('Child Category') . ':') !!}
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('weight',  'Gross Weight' . ':') !!}
      ...
      @endphp
        ...
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('product_custom_field1',  'Net Weight' . ':') !!}
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(document).on('change','#prod_type',function(){
      ...
      var base__prf = $('.sku_prefix').val();
      base__prf = base__prf.split('-')[0];
      base__prf = base__prf+'-';
      base__prf = base__prf+get__prf+'-';
      $('.sku_prefix').val(base__prf);
      $('.sku_prefix_addon').html(base__prf);
    })
