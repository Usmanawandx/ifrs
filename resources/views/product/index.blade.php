...
@section('content')
    ...
    <section class="content-header">
        <h1 class="top-heading">@lang('sale.products')
            @lang('lang_v1.manage_products')</span>
        </h1>
    </section>
                ...
                @component('components.filters', ['title' => __('report.filters')])
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::select('product_type_id', $product_type, null, [
                                'class' => 'form-control select2',
                                'style' => 'width:100%',
                                'id' => 'product_type_id',
                                'placeholder' => __('lang_v1.all'),
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change',
                '#product_list_filter_type, #product_list_filter_category_id, #product_list_filter_sub_category_id, #product_list_filter_brand_id, #product_type_id, #product_list_filter_unit_id, #product_list_filter_tax_id, #location_id, #active_state, #repair_model_id',
                function() {
