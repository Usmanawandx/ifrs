...
<script>
    $(document).ready(function(){
        ...
        var start__date = '{{request()->start}}';
        var end__date = '{{request()->end}}';
        if(start__date && end__date){
            dateRangeSettings.startDate = moment(start__date);
            dateRangeSettings.endDate = moment(end__date);
        }
