            ...
            <div class="col-md-6">
				<div class="form-group">
					<div class="input-group">
						...
						<input required class="form-control voucher_date" type="date" value="<?php echo date("Y-m-d"); ?>" name="receipt_date">
					</div>
				</div>
			</div>
			<div class="col-md-6">
           ...
           <table class="table table-bordered table-hover voucher_id" id="debtAccVoucher">
              <thead>
                 <tr>
                    ...
                    <th class="text-center">Attachment<i class="text-danger">*</i></th>
              ...
              <tbody id="debitvoucher">
                 <tr id="tr_data_display_1">
                    ...
                    <td><input type="file" name="attachment_child[]" value="" class="form-control"></td>
                    <td><input type="number" name="txtAmount[]" required min="1" value="0" class="form-control total_price text-right" id="txtAmount_1" onkeyup="total_amount()"  aria-required="true">
                    </td>
                 </tr>
              </tbody>
              <tfoot>
