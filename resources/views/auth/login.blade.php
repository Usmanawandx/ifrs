...
@section('content')
    <div class="login-form col-md-12 col-xs-12 right-col-content">
        ...
        <form method="POST" action="{{ route('login') }}" id="login-form">
            ...
            <div class="select-drop" style="margin-bottom: 15px">
                <select class="form-control select2" name="bussiness_locations" id="bussiness_locations" required>
            ...
            <div class="form-group row mn-lst-row">
                <div class="col-md-6 col-sm-6 checkbox icheck">
                    <label>
            ...
            <br>
            <div class="form-group btn-mn-sub">
