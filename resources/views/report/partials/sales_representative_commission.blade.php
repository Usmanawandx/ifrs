...
<table class="table table-bordered table-striped hide-footer dataTable table-styling table-hover table-primary" id="sr_sales_with_commission_table" style="width: 100%;">
    <thead>
        <tr>
