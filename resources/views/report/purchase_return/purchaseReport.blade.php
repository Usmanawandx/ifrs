...
<script type="text/javascript" src="https://html2canvas.hertzen.com/dist/html2canvas.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change', '#po_list_filter_products, #po_list_filter_location_id, #po_list_filter_supplier_id,#transporter, #vehicle, #sales_man, #transaction_accounts, #sell_list_filter_accountsType, #purchase_type, #product_type',  function() {
