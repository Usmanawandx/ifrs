                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="input_tax_tab">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped hide-footer dataTable table-styling table-hover table-primary no-footer" id="input_tax_table">
                                <thead>
                                    <tr>
                    ...
                    <div class="tab-pane" id="output_tax_tab">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped hide-footer dataTable table-styling table-hover table-primary" id="output_tax_table" width="100%">
                                <thead>
                                    <tr>
                                        <th>@lang('messages.date')</th>
                    ...
                    <div class="tab-pane" id="expense_tax_tab">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped hide-footer dataTable table-styling table-hover table-primary" id="expense_tax_table" width="100%">
                                <thead>
                                    <tr>
                                        <th>@lang('messages.date')</th>
                                        <th>@lang('purchase.ref_no')</th>
