...
<section class="content-header">
   <h1>
      {{$title}} <span class="pull-right top_trans_no">{{ $transaction->ref_no }}</span>
   </h1>
</section>
<!-- Main content -->
<section class="content">
   ...
   <div class="row">
      <div class="col-md-12 col-sm-12">
         ...
         <div>
            ...
            <div class="col-sm-3">
               <div class="form-group">
                  {!! Form::label('delivery_note_no', __('Delivery Note No') . ':*') !!}
                  {!! Form::select('delivery_note_no', $delivery_note_no ,$transaction->delivery_note_no, ['class' => 'form-control select2','id'=>'delivery_note', 'autofocus', 'placeholder' => __('messages.please_select')]); !!}
               </div>
            </div>
            ...
            <div class="col-sm-3">
               <div class="form-group">
                  ...
                  <div class="input-group">
                     <select class="form-control no-pointer-events get__prefix_edit" name="saleType" required readonly>
                        <option selected disabled> Select</option>
                        @foreach ($sale_category as $tp)
                        @if($transaction->saleType == $tp->id)
                        <option value="{{$tp->id}}" data-pf="{{$tp->prefix}}" data-trans_id="{{$tp->control_account_id}}" selected>{{$tp->name}}</option>
                        @else
                     ...
                     <button type="button" class="btn btn-default bg-white btn-flat btn-modal" data-href="{{action('SalesOrderController@sale_type_partial')}}" data-container=".view_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
                     </span>
                  </div>
               </div>
            </div>
            ...
            <div class="col-sm-3">
               <div class="form-group">
                  ...
                  {!! Form::text('ref_no',$transaction->ref_no, ['class' => 'form-control tr_no__edit','readonly']); !!}
               </div>
            </div>
            ...
            <div class="col-sm-4">
               <div class="form-group">
                  ...
                  <div class="input-group">
                     ...
                     <select name="contact_id" class="form-control select2" id="supplier_id" required onchange=get_ntn_cnic(this)>
            ...
            <div class="col-sm-3">
               <div class="form-group">
                  ...
                  {!! Form::text('ntncnic', $transaction->ntncnic, ['class' => 'form-control ntncnic', 'id'=>'ntncnic','placeholder' => __('NTN / CNIC No'),'readonly']); !!}
               </div>
            </div>
            ...
            <div class="col-md-3 pay_term">
               <div class="form-group">
                  ...
                  <br />
                  {!! Form::number('pay_term_number', $transaction->pay_term_number, ['class' => 'form-control width-40 pull-left', 'id'=>'pay_term_number','placeholder' => __('contact.pay_term')]); !!}
            ...
            <div class="col-sm-3">
                  ...
                  <select name="sales_man" class="form-control select2" id="sales_man">
                     ...
                     <option value="{{$s->id}}" selected  data-commission="{{$s->custom_field1}}">{{$s->supplier_business_name}}</option>
                     @else
                     <option value="{{$s->id}}"  data-commission="{{$s->custom_field1}}">{{$s->supplier_business_name}}</option>
                     @endif
                     @endforeach
                  </select>
            </div>
            ...
            <div class="col-md-3">
               <div class="form-group">
                  ...
                  {!! Form::textarea('additional_notes', $transaction->additional_notes, ['class' => 'form-control', 'id'=>'additional_notes','rows' => 1]); !!}
               </div>
            </div>
            ...
            <div class="col-sm-4 hide">
               <div class="form-group">
                  ...
                  {!! Form::text('sale_invoice_no', $transaction->sale_invoice_no, ['class' => 'form-control', 'placeholder' => __('Sale Invoice No'),'required']); !!}
            ...
            {{-- <div class="@if(!empty($commission_agent)) col-sm-4 @else col-sm-4 @endif" style="display: none;">
               <div class="form-group">
                  ...
                  {!! Form::select('saleType', $s_type,$transaction->saleType, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
               </div>
            </div> --}}
            ...
            <div class="col-sm-4 hide">
               <div class="form-group">
                  ...
                  {!! Form::text('gstno', $transaction->gstno, ['class' => 'form-control gst','id'=>'gstno' ,'placeholder' => __('GST NO')]); !!}
                  <p style="display: none;" class="help-block">@lang('lang_v1.keep_blank_to_autogenerate')</p>
               </div>
            </div>
            ...
            <div class="col-sm-4 hide">
               <div class="form-group">
                  ...
                  <div class="input-group">
                     ...
                     {!! Form::date('invoice_date', $transaction->invoice_date, ['class' => 'form-control', 'required']); !!}
                  </div>
               </div>
            </div>
            @php
         ...
         <div class="col-sm-4 ">
            <div class="form-group">
               ...
               <input type="text" class="form-control vehicles_input" value="{{ $transaction->vehicle_no }}" style="display: none;" placeholder="vehicle no" />
            </div>
         </div>
         --}}
         ...
         <!--<div class="col-sm-4">-->
         <!--	<label>Add Charges ( + )</label>-->
         <!--	<input type="number" class="form-control" name="add_charges" value="{{ $transaction->add_charges }}"/>-->
         <!--</div>-->
         <!--<div class="col-sm-4">-->
         <!--	<label>Less Charges ( - )</label>-->
         <!--	<input type="number" class="form-control" name="less_charges" value="{{ $transaction->less_charges }}"/>-->
         <!--</div>-->
         ...
         <div>
            ...
            <div class="col-md-4 @if($transaction->type == 'sales_order') hide @endif">
               <div class="form-group">
                  ...
                  <div class="input-group">
                     ...
                     {!! Form::select('discount_type', ['fixed' => __('lang_v1.fixed')], $transaction->discount_type , ['class' => 'form-control','placeholder' => __('messages.please_select'), 'data-default' => 'percentage']); !!}
                  </div>
               </div>
            </div>
            @php
            ...
            <div class="col-sm-4">
               ...
               <select name="prd_contractor" class="form-control prd_contractor">
                  @foreach ($contractor as $c)
                  <option value="{{$c['id']}}" {{ ($c['id'] == $transaction->prd_contractor) ? 'selected' : ''  }}>{{ $c['supplier_business_name'] }}</option>
                  @endforeach
               </select>
            </div>
            <div class="col-sm-12">
   ...
   <div class="row" style="background-color:white;padding:10px;">
      <div class="col-md-12 text-center fixed-button">
         ...
         <button type="button" class="btn btn-primary sale_submit btn-big" accesskey="s" id="submit-sell">update & close</button>
         @if($page === "convert_dn_to_si")
         <a href="{{action('SellPosController@destroy', [$transaction->id])}}" class="btn btn-danger delete-sale-invoice">Delete </a>
         @endif
...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      $("#TCS").trigger('change');
   	...
   	$(document).on('click', 'a.delete-sale-invoice', function(e) {
   		e.preventDefault();
   		swal({
   			title: LANG.sure,
   			icon: 'warning',
   ...
   function add_row(el) {
   	...
   	$('#pos_table tbody tr').each(function() {
   		$(this).find('#prd_select,#store_s,#tax_id,#further_tax,#brand_id').select2('destroy')
   	})
   ...
   function reIndexTable() {
   	var j = 0;
   	$('#pos_table tbody tr').each(function() {
   		$(this).find('#prd_select,#store_s,#tax_id,#further_tax,#brand_id').select2()
   		$(this).attr('id', j)
   	...
   	$.ajax({
   		...
   		success: function(data) {
   			...
   			if (IsRemoved == 'true') {} else {
   				...
   				// $('#pos_table').attr('_isRemoved','true')
   			}
   			...
   			$('#supplier_id option[value=' + data.po.contact_id + ']').attr("selected", true)
   			$('#supplier_id').select2()
				...
				success: function(data) {
					...
					$.each(data, function(index, value) {
						if (value.vhicle_number != null) {
                           var check= (vehicle_no == value.id) ? selected = "selected" : '';
							$('.vehicles').append('<option value="' + value.id + '" '+ check +'>' + value.vhicle_number + '</option>');
						} 
					});
				}
			})
