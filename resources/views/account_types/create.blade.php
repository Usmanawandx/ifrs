    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        	{!! Form::label('code', 'Code' . ':*') !!}
          	{!! Form::text('code', null, ['class' => 'form-control', 'required' ,'readonly' , 'placeholder' => 'code']); !!}
      	</div>
      ...
      <div class="form-group">
        	...
        	{{--
          	...
          	['class' => 'form-control','required', 'data-id' => $account_types->pluck('id') ,'placeholder' => __( 'messages.please_select' )]); !!} 
          	--}}
          	<select name="parent_account_type_id" class="form-control" id="parent_account_type_id" required>
          	    <option >Select Please</option>
          	    @foreach($account_types as $account_type)
                    <option value="{{ $account_type->id }}" data-id="{{ $account_type->code }}">{{ $account_type->name }}</option>
                @endforeach
          	</select>
      </div>
    </div>
