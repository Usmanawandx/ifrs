      ...
      <div class="col-md-6">
         <div class="form-group">
            <div class="input-group">
               ...
               {!! Form::text('v_no','J-'.$voucher_no, ['class' => 'form-control mousetrap', 'id' => 'v_no', 'placeholder' => __('Voucher NO'), 'readonly' => 'readonly']); !!}
      ...
      <table class="table table-bordered table-hover voucher_id" id="debtAccVoucher">
         ...
         <tbody id="debitvoucher">
            <tr class="tr_h">
               ...
               <td class="" width="200p">
                  <select class="form-control select2 myselect" name="debit_head[]" onchange="get_code(this)" required>
...
//         $('#debitvoucher tbody tr').each(function(){
...
//   }
function add_row(el){
        var tr = $("#debtAccVoucher #debitvoucher .tr_h:last");
        tr.find('.myselect').select2('destroy');
        var mytr = tr.clone();
        $("#debtAccVoucher tbody tr:last").after(mytr);
        mytr.find('input').val('');
        $('.myselect').select2();
   }
