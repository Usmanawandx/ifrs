    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
              ...
              <div class="form-group">
                  ...
                  {!! Form::text('account_number', null, ['class' => 'form-control', 'required', 'readonly','placeholder' => __( 'account.account_number' ) ]); !!}
              </div>
  
              <div class="form-group">
                  {{-- {!! Form::label('account_type_id', __( 'account.account_type' ) .":") !!} --}}
                  <label>Account Type :<span id="code_span pull-right"></span></label>
                  ...
                  <select name="account_type_id" id="account_type_id" class="form-control select2" required>
                      ...
                      @foreach($account_types as $account_type)
                          {{--<optgroup label="{{$account_type->name}}">--}}
                              <option value="{{$account_type->id}}" code="{{ $account_type->code }}">{{$account_type->name}}</option>
              ...
              <div class="form-group">
                  ...
                  {!! Form::checkbox('is_allow', 1, false, ['class' => 'is_allow']) !!} <!-- Checkbox with value 1 -->
              </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn bg-maroon saveAndNext">Save & Next</button>
