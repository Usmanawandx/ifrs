      ...
      <div class="col-md-6">
         <div class="form-group">
            <div class="input-group">
               ...
               <input required class="form-control" type="date" value="{{ date('Y-m-d', strtotime($AccountTransaction[0]->operation_date)) }}" name="date">
            </div>
         </div>
      </div>
      <div class="col-md-6">
     ...
     <table class="table table-bordered table-hover voucher_id" id="debtAccVoucher" style="max-width: 150% !important; width: 150% !important;">
         ...
         <tbody id="debitvoucher">
            ...
            <tr class="tr_h">
               ...
               <td><input type="text" name="txtCode[]" value="" class="form-control  txtCodecredit" id="txtCodecredit" readonly=""></td>
               <td class="" width="200p">
               ...
               <td><input type="number" name="document[]"  class="form-control total_price text-right" value="{{$debit->document}}" ></td>
               <td>
               ...
               <td><input type="number" name="amount[]" value="{{($debit->type == "debit") ? $debit->amount:'0'}}" class="form-control total_price text-right"  onkeyup="calculationContravoucher(1)"  aria-required="true">
