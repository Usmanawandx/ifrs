...
<script>
    $(document).ready(function(){
        ...
        //                     serverSide: true,
        //                     ajax: {
        //                         url: '{{action("AccountController@detail_show",[$account->id])}}',
        //                         data: function(d) {
        //                             var start = '';
        //                             var end = '';
        ...
        //                         // {data: 'action', name: 'action', visibility: false}
        //                     ],
        ...
        //                         var debitTotal = api
        //                             .column(6, { search: 'applied' }) // Column index 5 for "debit" column
        //                             .data()
        ...
        //                         var creditTotal = api
        //                             .column(7, { search: 'applied' }) // Column index 6 for "credit" column
        //                             .data()
        //                             .reduce(function (acc, curr) {
        //                                 return acc + parseNumber(curr);
        //                             }, 0);
        ...
        //                             .column(8, { search: 'applied' }) // Column index 8 for "balance" column
        //                             .data()
        //                             .reduce(function (acc, curr) {
        //                                 return acc + parseNumber(curr);
        //                             }, 0);
        ...
        //                         $(api.column(6).footer()).html(formatCurrency(debitTotal));
        //                         $(api.column(7).footer()).html(formatCurrency(creditTotal));
                                
        //                         $(api.column(8).footer()).html((debitTotal - creditTotal) < 0 ? 'Cr: ' + __currency_trans_from_en(Math.abs((debitTotal - creditTotal)), true) : 'Dr: ' + __currency_trans_from_en((debitTotal - creditTotal), true));
        //                     }     
