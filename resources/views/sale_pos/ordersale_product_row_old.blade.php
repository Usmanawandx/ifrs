...
<div class="col-sm-3">
				<div class="form-group">
                    ...
                    <select name="products[{{ $row_count }}][store]" class="form-control select2 input-sm purchase_line_tax_id" placeholder="'Please Select'" style="width: 90px">
...
<td>
	...
	@if(!empty($is_direct_sell))
		...
		<td class="get_total">
			<input class="calculate_discount form-control" type="text">
		</td>
