  ...
  @component('components.widget')
      ...
      <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::select('transaction_account[]', $transaction_account->pluck('name','id'), null, ['class' => 'form-control select2', 'required', 'multiple','id' =>'transaction_account']); !!}
            
            <div class="transaction_account_div">
...
<script type="text/javascript">
    ...
    //     $('.transaction_account_div').html('');
    //     $('.transaction_account_div').append(`<input type="hidden" name="tr_account_code" value="${}">`);
    // })
