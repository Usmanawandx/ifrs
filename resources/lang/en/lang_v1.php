...
return [
   ...
   'payment_paid_notification' => 'Payment Paid Notification',
    ...
    'add_purchase_return' => 'Create Purchase Return',
    ...
    'sell_permissions_tooltip' => 'To view sales on the basis of payment status <b> View all Sale</b> permission is required otherwise it will filter with only sales created by the logged in user',
    'access_pending_shipments_only' => 'Access pending shipments only',
    'access_all_sell_return' => 'Access all Sale retrun',
    'access_own_sell_return' => 'Access own Sale retrun',
