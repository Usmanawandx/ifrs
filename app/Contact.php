...
class Contact extends Authenticatable
{
    ...
    */
    ...
    {
        return $this->hasMany(contact_address_line::class,'contact_id','id');
    }
    ...
    {
        $query->where('contacts.type', 'Agent');
    ...
    // 
    // Contracter
    public function scopeOnlycontracter($query)
    {
        $query->whereIn('contacts.type',['contracter','Transporter']);
