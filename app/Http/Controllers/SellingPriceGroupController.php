    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($price_groups)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'SellingPriceGroupController@edit\', [$id])}}" class="btn btn-xs btn-primary btn-modal btn-edt" data-container=".view_modal"><i class="glyphicon glyphicon-edit"></i></button>
                        &nbsp;
                        <button data-href="{{action(\'SellingPriceGroupController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_spg_button btn-dlt"><i class="glyphicon glyphicon-trash"></i></button>
                        &nbsp;
                        <button data-href="{{action(\'SellingPriceGroupController@activateDeactivate\', [$id])}}" class="btn btn-xs @if($is_active) btn-danger @else btn-success @endif activate_deactivate_spg btn-dlt"><i class="fas fa-power-off"></i> @if($is_active)  @else  @endif</button>'
                )
