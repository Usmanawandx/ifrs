...
class StockTransferController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input_data = $request->only([ 'location_id', 'ref_no', 'transaction_date','posting_date','transfer_date','vehicle_no','from_store','to_store','additional_notes', 'shipping_charges', 'final_total']);
                ...
                foreach ($products as $product) {
                    $sell_line_arr = [
                                ...
                                'item_code' => !empty($product['item_code']) ? $product['item_code'] : null,
                                 ...
                                 'discount_percent' => !empty($product['discount_percent']) ? $product['discount_percent'] : null,
                                 'tax_id' => null];
                    ...
                    // $purchase_line_arr['purchase_price_inc_tax'] = $sell_line_arr['purchase_price_inc_tax'];
