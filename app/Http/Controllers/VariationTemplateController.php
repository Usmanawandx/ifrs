    ...
    public function index()
    {
        if (request()->ajax()) {
            ...
            return Datatables::of($variations)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'VariationTemplateController@edit\', [$id])}}" class="btn btn-xs btn-primary edit_variation_button btn-edt"><i class="glyphicon glyphicon-edit"></i></button>
                        &nbsp;
                        @if(empty($total_pv))
                        <button data-href="{{action(\'VariationTemplateController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_variation_button btn-dlt"><i class="glyphicon glyphicon-trash"></i></button>
                        @endif'
                )
